...
namespace SuppliersMVC.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            group.SuppliersList = (from supToGroup in db.SupplierToGroup
                                       where supToGroup.GroupId == id.Value
                                       join supplier in db.Suppliers on supToGroup.SupplierId equals supplier.SupplierId
